...
import { Menu, Home, Bell, CreditCard } from "lucide-react"
...
export default function App() {
  ...
  return (
    <div className="min-h-screen max-w-xl bg-blue-900 flex flex-col">
      {showSplash ? (
        ...
        <>
          ...
          {showMenu && (
            <div className="absolute h-36 w-36 left-0 bottom-0 space-y-2">
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-blue-600 text-white absolute top-0 left-5"
              ...
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-blue-600 text-white absolute top-2 left-16"
              ...
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-blue-600 text-white absolute top-10 left-24"
              ...
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-blue-600 text-white absolute bottom-[7px] right-[0px]"
                onClick={() => handleMenuItemClick('card')}
              >
                <CreditCard className="h-6 w-6" />
              </Button>
